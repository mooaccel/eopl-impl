...
(define test_03_ast_example
  (multiplication-exp (addition-exp (const-exp 100)
                                    (var-exp 'x))
                      (var-exp 'y)))
; 2926
(eopl:pretty-print (value-of test_03_ast_example
                             test_init_env))
(define test_04_ast_example
  (div-exp (addition-exp (const-exp 100)
                         (var-exp 'x))
           (var-exp 'y)))
(eopl:pretty-print (value-of test_04_ast_example
                             test_init_env))
(eopl:pretty-print (value-of (div-exp (var-exp 'x)
                                      (const-exp 3))
                             test_init_env))