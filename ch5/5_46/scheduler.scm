(module lang (lib "eopl")
  ...
  ; get-the-time-remaining, set-the-time-remaining!提供给yield-exp使用
  ; 用于覆盖默认的(set! the_time_remaining the_max_time_slice) 
  (define set-the-time-remaining!
    (lambda (timeslice_remaining)
      (set! the_time_remaining timeslice_remaining)))
